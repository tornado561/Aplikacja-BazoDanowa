    ...
    class Methods
    {
        ...
        public int updateRecord(int id, string kategoria, string nazwa, string cena, string ilosc, string zdjecie, string link)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(conString))
            {
                ...
                string updateClient = "UPDATE przedmioty SET kategoria = @kategoria , nazwa = @nazwa, cena = @cena , ilosc = @ilosc, zdjecie = @zdjecie, link = @link WHERE idPodstawowy = @id";
                connection.Open();
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    cmd.Connection = connection;
        ...
        public int deleteRecord(int id, string kategoria, string nazwa)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(conString))
            {
                ...
                string deleteClient = "DELETE FROM przedmioty WHERE kategoria = @kategoria AND nazwa = @nazwa AND idPodstawowy = @id";
                connection.Open();
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    cmd.Connection = connection;
